...
# -*- coding: utf-8 -*-
#
# ipypixano documentation build configuration file
#
...
project = 'ipypixano'
copyright = '2022, nicolas allezard'
...
_version_py = os.path.join(repo, 'ipypixano', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipypixanodoc'
...
latex_documents = [
    (master_doc, 'ipypixano.tex', 'ipypixano Documentation',
     'nicolas allezard', 'manual'),
]
